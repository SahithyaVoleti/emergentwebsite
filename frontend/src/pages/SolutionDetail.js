                ...
                <div className="max-w-4xl">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-10 border-t border-slate-100">
                    <div className="group">
                      ...
                      <h4 className="text-[10px] font-black text-[#0B1B3D] uppercase tracking-widest mb-3">Core Value Proposition</h4>
                    ...
                    <div className="group">
                      ...
                      <h4 className="text-[10px] font-black text-[#0B1B3D] uppercase tracking-widest mb-3">Deployment Fit</h4>
                      <p className="text-[13px] text-slate-500 leading-relaxed font-medium">
            ...
            <div className="lg:col-span-12 xl:col-span-4">
              <AnimatedSection delay={0.2}>
                <div className="bg-[#F1F5F9]/50 border border-slate-200 rounded-3xl p-8 sm:p-10 sticky top-24 shadow-sm">
                  <div className="mb-10">
                    <h3 className="text-[10px] font-black text-[#0B1B3D] uppercase tracking-[0.3em] mb-6 border-b border-slate-200 pb-3">Technology Stack</h3>
                  ...
                  <div>
                    <h3 className="text-[10px] font-black text-[#0B1B3D] uppercase tracking-[0.3em] mb-6 border-b border-slate-200 pb-3">Primary Use Cases</h3>
                    ...
                    <div className="flex items-center gap-4 p-4 bg-white border border-slate-100 rounded-xl hover:shadow-lg hover:border-blue-500/20 transition-all duration-300 group">
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <h3 className="text-[13px] font-black text-[#0B1B3D] tracking-tight uppercase">{s.step}</h3>
                        </div>
