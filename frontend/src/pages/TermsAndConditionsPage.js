...
const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-[#7d8597]">Service scope, deliverables, timelines, and responsibilities are defined through approved proposals, statements of work, or contracts.</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-[#7d8597]">Commercial terms are defined in the applicable engagement agreement.</p>
        <p className="mt-4 text-[#7d8597]">
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-[#7d8597]">You agree not to misuse our website, services, systems, or content.</p>
        <ul className="mt-4 space-y-3">
          {[
