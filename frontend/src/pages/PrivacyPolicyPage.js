...
const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-6 text-sm font-medium text-[#111]">This may include:</p>
        <ul className="mt-4 space-y-3">
          {[
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-[#555]">We use cookies and analytics technologies to operate and improve our website experience.</p>
        <p className="mt-6 text-sm font-medium text-[#111]">These technologies support:</p>
        <ul className="mt-4 space-y-3">
          {[
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-[#555]">We maintain administrative, technical, and organizational safeguards proportionate to the nature of the services delivered.</p>
        <p className="mt-4 text-[#555]">
  ...
  },
  {
    ...
    content: (
      <div className="inline-flex border border-[#8b1538]/30 bg-[#fdf2f4] px-3 py-1 text-xs font-medium text-[#7a1528]">
