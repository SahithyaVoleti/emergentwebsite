    ...
    <SitePageMain>
      <section className="ubuntu-section-block border-b border-[#d9d9d9] bg-white">
        <div className="ubuntu-container flex min-h-[50vh] flex-col items-start justify-center py-16">
          ...
          <h1 className="ubuntu-section-title text-[#111]">Page not found</h1>
          <p className="ubuntu-lead mt-4 max-w-xl text-[#333]">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <Link to="/services" className="text-sm font-medium text-[#8b1538] hover:underline">
              Services
            </Link>
            <Link to="/solutions" className="text-sm font-medium text-[#8b1538] hover:underline">
              Platforms
            </Link>
            <Link to="/#page-contact" className="text-sm font-medium text-[#8b1538] hover:underline">
              Contact
            </Link>
          </div>
        </div>
