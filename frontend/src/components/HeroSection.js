...
export default function HeroSection() {
  return (
    <section 
      ...
      className="relative w-full min-h-[calc(100vh-120px)] bg-gradient-to-br from-[#F4F5F7] via-[#FFFFFF] to-[#E9F0FC] z-10 overflow-hidden px-4 sm:px-6 lg:px-12 xl:px-20 flex flex-col justify-center md:border-b border-slate-100"
    >
