const coreTechData = {
  "artificial-intelligence": [
    ...
    { name: "Cloud & ML serving", description: "Deploy models on managed ML platforms with governed promotion paths and operational monitoring.", techs: [{ name: "AWS SageMaker" }, { name: "Azure ML" }, { name: "GCP Vertex AI" }, { name: "Serverless" }] },
  ],
  "generative-ai": [
