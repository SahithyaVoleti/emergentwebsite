...
const industries = [
  {
    ...
    heroTitle: "AI agents for retail and commerce applications",
    heroDesc: "We build agents that work inside your POS, ERP, WMS, and e-commerce admin tools—automating inventory checks, pricing decisions, and support workflows your store teams already use.",
    ...
    highlights: [
      "Industry ready agents: Agent Vyapar for replenishment inside ERP and warehouse applications",
    ...
    faqs: [
      ...
      { q: "Can agents work inside our existing ERP?", a: "Yes. We embed agents in ERP screens, add side-panel copilots, or connect through APIs—without replacing the system you already run." },
  ...
  },
  {
    ...
    heroTitle: "AI agents for healthcare applications",
    heroDesc: "We place agents inside EHR systems, scheduling software, and patient portals—reducing documentation load and supporting clinical workflows with HIPAA-aligned controls and human review.",
    heroImage: industryImages[1],
    overview:
      "Healthcare runs on EHR platforms, scheduling tools, billing systems, and patient-facing apps. We build agents that live inside those applications—drafting notes, routing triage, and answering staff questions—while clinicians stay in control of every clinical decision.",
    highlights: [
      "Industry ready agents: Agent Arogya for structured note drafting inside EHR workflows",
  ...
  },
  {
    ...
    heroTitle: "AI agents for financial services applications",
    heroDesc: "We embed agents in core banking tools, loan origination systems, CRM, and compliance platforms—detecting fraud, speeding KYC, and processing documents with full audit trails.",
    heroImage: industryImages[2],
    overview:
      "Banks and fintechs run on core systems, loan apps, trading platforms, and compliance tools. We build agents inside those applications so analysts get faster alerts, cleaner case files, and cited answers—without bypassing the controls regulators expect.",
    highlights: [
      "Industry ready agents: Agent Kavacha for transaction monitoring inside AML applications",
  ...
  },
  {
    ...
    heroTitle: "AI agents for education applications",
    heroDesc: "We build copilots inside LMS platforms, student information systems, and admin portals—helping teachers grade, plan, and support students while keeping FERPA and COPPA boundaries clear.",
    heroImage: industryImages[3],
    overview:
      "Schools and EdTech companies run on LMS tools, student information systems, and admin software. We embed agents in those applications so educators spend less time on repetitive tasks—and students get help inside the portals they already use.",
    highlights: [
      "Industry ready agents: Agent Vidya for rubric-aligned grading inside LMS tools",
  ...
  },
  {
    ...
    heroTitle: "AI agents for manufacturing applications",
    heroDesc: "We place agents in MES, CMMS, ERP, and operator HMIs—predicting maintenance needs, flagging defects, and planning production inside the software your plant teams use daily.",
    heroImage: industryImages[6],
    overview:
      "Factories run on MES, ERP, CMMS, and shop-floor HMIs. We build agents inside those applications—and on edge devices where needed—so operators and planners get alerts and recommendations without leaving their screens.",
    highlights: [
      "Industry ready agents: Agent Yantra for predictive maintenance inside CMMS applications",
  ...
  },
  {
    ...
    heroTitle: "AI agents for sports and gaming applications",
    heroDesc: "We build agents inside coaching platforms, fan apps, broadcast tools, and game backends—turning telemetry and audience data into actions your teams can use in the software they already run.",
    heroImage: industryImages[4],
    overview:
      "Sports and gaming organizations use coaching apps, fan mobile apps, CMS tools, and game servers. We embed agents in those systems—for performance insights, content creation, and player experiences—without bolting on separate AI tools.",
    highlights: [
      "Industry ready agents: Agent Chitra for performance summaries inside coaching applications",
  ...
  },
  {
    ...
    heroTitle: "AI agents for real estate applications",
    heroDesc: "We embed agents in CRM, MLS-connected tools, and property portals—qualifying leads, drafting valuations, and processing documents inside the apps agents and brokers already use.",
    heroImage: industryImages[5],
    overview:
      "Real estate runs on CRM, MLS integrations, transaction management, and client portals. We build agents inside those applications so brokers spend less time on paperwork and more time with clients—or we modernize legacy PropTech software with built-in intelligence.",
    highlights: [
      "Industry ready agents: Agent Bhumi for lead prioritization inside CRM applications",
  ...
  },
  {
    ...
    heroTitle: "AI agents for agriculture applications",
    heroDesc: "We build agents inside farm management systems, logistics ERPs, and field apps—helping agronomists plan irrigation, monitor crop health, and trace supply chains in software they use in the office and field.",
    heroImage: industryImages[7],
    overview:
      "Agriculture teams use farm management systems, logistics platforms, and mobile field apps. We embed agents in those tools—or modernize them with AI—so recommendations on yield, irrigation, and traceability appear where decisions are made.",
    highlights: [
      "Industry ready agents: Agent Krishi for yield forecasting inside farm management dashboards",
  ...
  },
  {
    ...
    heroTitle: "AI agents for biotechnology applications",
    heroDesc: "We embed agents in lab notebooks, LIMS, QMS, and manufacturing systems—searching protocols, triaging deviations, and preparing regulatory packages inside GxP-aware workflows.",
    heroImage: industryImages[8],
    overview:
      "Biotech and life sciences run on ELN, LIMS, QMS, and manufacturing execution systems. We build agents inside those applications so scientists and QA teams find answers faster—without breaking traceability or validation requirements.",
    highlights: [
      "Industry ready agents: Agent Shodh for experiment search inside electronic lab notebooks",
  ...
  },
  {
    ...
    heroTitle: "AI agents for government applications",
    heroDesc: "We build agents inside citizen portals, case management systems, and staff intranets—routing inquiries, searching policy, and processing forms with residency, accessibility, and audit requirements built in.",
    heroImage: industryImages[9],
    overview:
      "Agencies run on case systems, citizen portals, and document repositories. We embed agents in those applications—and modernize legacy public-sector software—so staff and citizens get faster service without sacrificing transparency or data sovereignty.",
    highlights: [
      "Industry ready agents: Agent JanSeva for inquiry routing inside public portals",
